...
public class MazeRunnerObserver extends JFrame implements Observer, Runnable {
	...
	public void update(Observable o, Object arg) {
		if (o instanceof MazeRunner) {
			...
			if (this.topLabel.getComponentCount() > 1)
				this.topLabel.remove(1);
			this.width = width;
			this.height = height;
			this.topLabel.setPreferredSize(new Dimension(this.width,
					this.height));
